...
<main>
  ...
  <div id="section-two" >
    <div class="headlinecontainer">
      <h1 id="h1-special" class="py-3">Video</h1>
    </div>
    
    <div class="videocontainer">
      <div class="videocontainer-top outer-col-12 my-4">
  ...
  <div id="section-three">
    ...
    <h1 id="h1-special" class="py-3">Contact</h1>
    <p>
      For more information please contact: 
    </p>
  <p>
      heididavidsen@gmail.com
...
body.dark [class^="outer-col-"] {
  background-color: #18668d;
}

body.dark [class^="inner-col-"] {
  background-color: #18668d;
}
...
body.dark .btn-primary, body.dark .btn-secondary, .btn-primary, .btn-secondary {
  display: inline-block;
  border-radius: 5px;
  padding: 8px 20px;
  margin: 3px;
...
body.dark .btn-primary:hover, body.dark .btn-secondary:hover, .btn-primary:hover, .btn-secondary:hover {
